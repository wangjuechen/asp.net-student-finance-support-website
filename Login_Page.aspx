...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p style="height: 28px" class="style2">
        &nbsp;</p>
    <p style="height: 28px" class="style2">
        <span class="style1">&nbsp;LOGIN ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</span>&nbsp;<asp:TextBox ID="txbLogin" runat="server" Width="104px"></asp:TextBox>
</p>
<p style="height: 28px" class="style2">
    <span class="style1">PASSWORD:&nbsp;</span>&nbsp;&nbsp;&nbsp;
    <asp:TextBox ID="txbPassword" runat="server" TextMode="Password" Width="104px"></asp:TextBox>
</p>
